...
<title>Airtel Recharge Plans</title>
</head>
<style>
body{
...
<body>
	...
	if (c != null) {
		ArrayList<Recharge_Plans> lst = (ArrayList<Recharge_Plans>) session.getAttribute("airtel");
	%>
	...
	<ul class="nav justify-content-end">
		...
		<div  style="background:black; color:white; margin-left:30%; margin-right:30% ; opacity:0.8;"><h1 class="h-primary centre" style="padding:10px;">Airtel Recharge</h1>
		</div>
									...
									<div class="p-3 border bg-light"
										...
										<form action="MobileNoTransferController">
											<input type="hidden" class="form-control"
												...
												name="phnor" value="9963852585"> <input
