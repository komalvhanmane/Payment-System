...
<body>
	...
	if (c != null) {
		ArrayList<DTH_RechargePlan> lst = (ArrayList<DTH_RechargePlan>) session.getAttribute("2");
	%>
	...
	<ul class="nav justify-content-end">
			...
			<div  style="background:black; color:white; margin-left:30%; margin-right:30% ; opacity:0.8;"><h1 class="h-primary centre" style="padding:10px;">Dish DTH Recharge</h1>
		</div>
									...
									<div class="p-3 border bg-light"
										...
										<form action="MobileNoTransferController">
											<input type="hidden" class="form-control"
												...
												name="phnor" value="9567878312"> <input
